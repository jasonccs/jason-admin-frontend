      ...
      <el-col :xs="8" :sm="8" :lg="6" class="card-panel-col">
        <el-card>
          ...
          <div class="log-files">
            ...
            <div v-if="file.pagetotal > 1" class="file-pagination">
              <el-button
                v-waves
                type="primary"
                style="width:45%;"
          ...
          <div class="log-container">
            <div class="log-file-detail">
              <el-row :gutter="0" class="panel-group">
                ...
                <el-col v-if="log.listQuery.file != ''" :xs="6" :sm="6" :lg="6" class="card-panel-col">
            ...
            <div class="log-content">
              ...
              <div v-if="log.filesize > log.readsize" class="log-pagination">
                <el-button
                  v-waves
                  type="primary"
                  style="width:100px;"
